...
fn run_without_number_and_number_nonblank_multiple_files(){
    ...
    dbg!("{}",String::from_utf8(org_res.stdout.clone()).unwrap());
    dbg!("{}",String::from_utf8(new_res.stdout.clone()).unwrap());
    assert_eq!(String::from_utf8(org_res.stdout).unwrap(),String::from_utf8(new_res.stdout).unwrap())
}
#[test]
...
fn run_with_number_nonblank_multiple_files_combine_cmd(){
    ...
    dbg!("{}",String::from_utf8(org_head_res.stdout.clone()).unwrap());
    dbg!("{}",String::from_utf8(new_head_res.stdout.clone()).unwrap());
